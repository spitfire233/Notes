...
\end{center}
vediamo come esso cambia facendo alcune variazioni non lineari: al posto del secondo e terzo vincolo consideriamo il vincolo:
$$9x_1^2 + 5x_2^2 \leq 216$$
\begin{center}
    \includegraphics[width = 0.30\linewidth]{Images/85.png}
\end{center}
\begin{center}
    \includegraphics[width = 0.35\linewidth]{Images/86.png}
\end{center}
Il punto di ottimo è ancora $(2,6)$ ma \textbf{non è più un vertice}.
L'ottimo del problema non apparterrà necessariamente all'insieme dei vertici ammissibili.
L'algoritmo del simplesso non si può quindi più utilizzare.
Al posto di una funzione obbiettivo lineare consideriamo una nuova funzione non lineare:
\begin{center}
    \includegraphics[width = 0.45\linewidth]{Images/87.png}
\end{center}
\begin{center}
    \includegraphics[width = 0.50\linewidth]{Images/88.png}
\end{center}
Il punto di ottimo è $(3,3)$ e \textbf{non è più sulla frontiera della regione ammissibile}.
La ricerca del punto di ottimo non è più ristretta in generale alla frontiera del problema. La soluzione
potrebbe essere in un qualunque punto della regione ammissibile.
